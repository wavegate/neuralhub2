  ...
  render() {
    return (
      <div>
        <form>
          <div>
            First, enter the code block or inline snippet you wish to format
            with Prism.js:
          </div>
          <textarea
            name="code"
          ...
          />
          <div>Select the language the code is written in:</div>
          <select
          ...
          <div>Choose if you want the code in block or inline form:</div>
          <select
        ...
        <div>
          Here is the resulting code you can add to your HTML file. If you're
          not sure how to use this, please see instructions on how to install
          Prism.js and the required plugins below.
        </div>
